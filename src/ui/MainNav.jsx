...
import { HiOutlineCalendarDays, HiOutlineCog6Tooth, HiOutlineHome, HiOutlineHomeModern, HiOutlineUsers, HiOutlineUserCircle } from "react-icons/hi2";
  ...
  return (
    <nav>
      <NavList>
        ...
        <li><StyledNavLink to="/guests"><HiOutlineUsers /><span>Guests</span></StyledNavLink></li>
        <li><StyledNavLink to="/users"><HiOutlineUserCircle /><span>New User</span></StyledNavLink></li>
